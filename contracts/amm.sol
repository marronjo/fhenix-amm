...
contract AMM is Permissioned {
    ...
    function swap(
        ...
        //i_token0.transferEncrypted(msg.sender, FHE.asEuint32(token1Amount));
        //i_token1.transferEncrypted(msg.sender, FHE.asEuint32(token0Amount));
    ...
    function addLiquidity(
        ...
        //TODO - fix nonce error / headers timeout
        i_token1.transferFromEncrypted(msg.sender, address(this), optAmount1); //throws nonce error!
